...
**************************************************************************
	...
	Die Lebzeiten von Threadforum und TForum_access m�ssen
	...
	TForum_access: zwischen enter() und leave() sollte TForum_access
		nicht zerst�rt werden. Sollte TForum_access trotzdem zerst�rt
		werden, wird der angegebene io_context fehlerhaft und muss
		zur�ckgesetzt werden.

	TODO: Umstellen auf Process. Handhabung obiges erübrigt sich.
