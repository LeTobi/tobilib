...
networking: base network/endpoint.o network/client.o network/acceptor.o network/server.o h2ep/event.o h2ep/xendpoint.o h2ep/xclient.o h2ep/xserver.o thread/mtcom.o
	ar r libtc.a network/endpoint.o
	ar r libtc.a network/client.o
	ar r libtc.a network/acceptor.o
	ar r libtc.a network/server.o
	ar r libtc.a h2ep/event.o
	ar r libtc.a h2ep/xendpoint.o
	ar r libtc.a h2ep/xclient.o
	ar r libtc.a h2ep/xserver.o
...
network/server.o: network/server.h network/server.cpp
	g++ network/server.cpp -std=c++11 -c -o network/server.o
...
h2ep/xserver.o: h2ep/server.h h2ep/server.cpp
	g++ h2ep/server.cpp -std=c++11 -c -o h2ep/xserver.o
